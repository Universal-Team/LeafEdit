...
void Settings::Draw(void) const
{
	...
	if (Selection == 0) {
		Gui::Draw_Rect(settingsButtons[0].x, settingsButtons[0].y, settingsButtons[0].w, settingsButtons[0].h, RED);
		...
		Gui::Draw_Rect(settingsButtons[1].x, settingsButtons[1].y, settingsButtons[1].w, settingsButtons[1].h, RED);
		Gui::Draw_Rect(settingsButtons[2].x, settingsButtons[2].y, settingsButtons[2].w, settingsButtons[2].h, GREEN);

	} else if (Selection == 2) {
		Gui::Draw_Rect(settingsButtons[0].x, settingsButtons[0].y, settingsButtons[0].w, settingsButtons[0].h, GREEN);
		Gui::Draw_Rect(settingsButtons[1].x, settingsButtons[1].y, settingsButtons[1].w, settingsButtons[1].h, GREEN);
		Gui::Draw_Rect(settingsButtons[2].x, settingsButtons[2].y, settingsButtons[2].w, settingsButtons[2].h, RED);
	}
