...
void VillagerEditor::DrawEditorSub(void) const {
	...
	Gui::DrawStringCentered(0, Buttons[1].y+10, 0.6f, TXTCOLOR, Lang::get("MANUALLY"), 130);
}
...
void VillagerEditor::DrawSubMenu(void) const
{
	...
	Gui::DrawTop();
	Gui::DrawStringCentered(0, 212, 0.8f, TXTCOLOR, currentPage, 390);
	...
	if (subMenuPage == 1) {
		...
		Gui::DrawStringCentered(-160, 83, 0.55f, TXTCOLOR, g_groups[10], 60);

		Gui::Draw_Rect(85, 30, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(142, 90, 28);
		Gui::DrawStringCentered(-80, 83, 0.55f, TXTCOLOR, g_groups[11], 60);

		Gui::Draw_Rect(165, 30, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(283, 170, 28);
		Gui::DrawStringCentered(0, 83, 0.55f, TXTCOLOR, g_groups[12], 60);

		Gui::Draw_Rect(245, 30, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(148, 250, 28);
		Gui::DrawStringCentered(80, 83, 0.55f, TXTCOLOR, g_groups[13], 60);

		Gui::Draw_Rect(325, 30, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(159, 330, 28);
		Gui::DrawStringCentered(160, 83, 0.55f, TXTCOLOR, g_groups[14], 60);

		// Second Row!

		Gui::Draw_Rect(5, 140, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(176, 10, 138);
		Gui::DrawStringCentered(-160, 193, 0.55f, TXTCOLOR, g_groups[15], 60);

		Gui::Draw_Rect(85, 140, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(181, 90, 138);
		Gui::DrawStringCentered(-80, 193, 0.55f, TXTCOLOR, g_groups[16], 60);

		Gui::Draw_Rect(165, 140, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(190, 170, 138);
		Gui::DrawStringCentered(0, 193, 0.55f, TXTCOLOR, g_groups[17], 60);

		Gui::Draw_Rect(245, 140, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(199, 250, 138);
		Gui::DrawStringCentered(80, 193, 0.55f, TXTCOLOR, g_groups[18], 60);

		Gui::Draw_Rect(325, 140, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(208, 330, 138);
		Gui::DrawStringCentered(160, 193, 0.55f, TXTCOLOR, g_groups[19], 60);
		...
		Gui::DrawStringCentered(-160, 83, 0.55f, TXTCOLOR, g_groups[20], 60);

		Gui::Draw_Rect(85, 30, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(224, 90, 28);
		Gui::DrawStringCentered(-80, 83, 0.55f, TXTCOLOR, g_groups[21], 60);

		Gui::Draw_Rect(165, 30, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(239, 170, 28);
		Gui::DrawStringCentered(0, 83, 0.55f, TXTCOLOR, g_groups[22], 60);

		Gui::Draw_Rect(245, 30, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(247, 250, 28);
		Gui::DrawStringCentered(80, 83, 0.55f, TXTCOLOR, g_groups[23], 60);

		Gui::Draw_Rect(325, 30, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(258, 330, 28);
		Gui::DrawStringCentered(160, 83, 0.55f, TXTCOLOR, g_groups[24], 60);

		// Second Row!

		Gui::Draw_Rect(5, 140, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(272, 10, 138);
		Gui::DrawStringCentered(-160, 193, 0.55f, TXTCOLOR, g_groups[25], 60);

		Gui::Draw_Rect(85, 140, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(278, 90, 138);
		Gui::DrawStringCentered(-80, 193, 0.55f, TXTCOLOR, g_groups[26], 60);

		Gui::Draw_Rect(165, 140, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(300, 170, 138);
		Gui::DrawStringCentered(0, 193, 0.55f, TXTCOLOR, g_groups[27], 60);

		Gui::Draw_Rect(245, 140, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(305, 250, 138);
		Gui::DrawStringCentered(80, 193, 0.55f, TXTCOLOR, g_groups[28], 60);

		Gui::Draw_Rect(325, 140, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(337, 330, 138);
		Gui::DrawStringCentered(160, 193, 0.55f, TXTCOLOR, g_groups[29], 60);
		...
		Gui::DrawStringCentered(-160, 83, 0.55f, TXTCOLOR, g_groups[30], 60);

		Gui::Draw_Rect(85, 30, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(349, 90, 28);
		Gui::DrawStringCentered(-80, 83, 0.55f, TXTCOLOR, g_groups[31], 60);

		Gui::Draw_Rect(165, 30, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(362, 170, 28);
		Gui::DrawStringCentered(0, 83, 0.55f, TXTCOLOR, g_groups[32], 60);

		Gui::Draw_Rect(245, 30, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(382, 250, 28);
		Gui::DrawStringCentered(80, 83, 0.55f, TXTCOLOR, g_groups[33], 60);

		Gui::Draw_Rect(325, 30, 70, 70, BGBOTCOLOR);
		VillagerManagement::DrawVillager(388, 330, 28);
		Gui::DrawStringCentered(160, 83, 0.55f, TXTCOLOR, g_groups[34], 60);
	}
...
void VillagerEditor::DrawVillagerSelection(void) const {
	...
	for (u32 y = 0; y < 2; y++) {
		for (u32 x = 0; x < 5; x++, villager++) {
			...
			Gui::DrawString(15 + x * 75, 95 + y * 90, 0.45f, TXTCOLOR, g_villagerDatabase[villager], 400);
		}
	}
}
...
void VillagerEditor::DrawVillagerSetTest(void) const {
	...
	Gui::DrawStringCentered(0, 2, 0.7f, TXTCOLOR, Lang::get("CHANGE_VILLAGER_LR"), 310);
	Gui::DrawStringCentered(0, 160, 0.7f, TXTCOLOR, villagerID, 310);
	Gui::DrawStringCentered(0, 130, 0.7f, TXTCOLOR, villagerNameText, 310);
	Gui::DrawStringCentered(0, 212, 0.8f, TXTCOLOR, IDs, 390);
	Gui::DrawBottom();
