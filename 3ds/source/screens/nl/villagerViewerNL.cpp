...
void VillagerViewerNL::Draw(void) const
{
	...
	SpriteManagement::DrawVillager(villagerNL->id(), 160, 60);
	Gui::DrawStringCentered(0, 130, 0.9f, WHITE, "VillagerName: " + g_villagerDatabase[villagerNL->id()], 395);
	GFX::DrawBottom();
}
