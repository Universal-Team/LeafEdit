...
void Initial::Draw(void) const
{
	...
	Gui::sprite(0, sprites_stackZ_idx, -20, 100);
	// Draw all supported Game sprites.
	Gui::sprite(0, sprites_Icon_idx, 260, 100);
	Gui::sprite(0, sprites_IconWA_idx, 260, 155);
	Gui::sprite(0, sprites_IconWL_idx, 320, 100);
	Gui::sprite(0, sprites_IconWW_idx, 320, 155);
	// Draw the Highlight -> The LeafEdit Icon! ;P
	Gui::sprite(0, sprites_leafEdit_idx, 145, 100, 2, 2);
