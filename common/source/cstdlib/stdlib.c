...
struct LibraryFunction StdlibFunctions[] = {{StdlibAtof, "double atof(char *);"}, {StdlibStrtod, "double strtod(char *,char **);"},
	...
	{StdlibRealloc, "void *realloc(void *,int);"}, {StdlibFree, "void free(void *);"}, {LeafEdit_Rand, "int rand();"}, {LeafEdit_Srand, "void srand(int);"},
	{StdlibAbort, "void abort();"}, {StdlibExit, "void exit(int);"}, {StdlibGetenv, "char *getenv(char *);"}, {StdlibSystem, "int system(char *);"},
